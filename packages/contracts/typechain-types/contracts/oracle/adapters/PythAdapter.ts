...
export interface PythAdapterInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "ROLE_ADMIN"
...
export interface PythAdapter extends BaseContract {
  connect(runner?: ContractRunner | null): PythAdapter;
  waitForDeployment(): Promise<this>;

  interface: PythAdapterInterface;
