...
export interface RedStoneAdapterInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "ROLE_ADMIN"
...
export interface RedStoneAdapter extends BaseContract {
  connect(runner?: ContractRunner | null): RedStoneAdapter;
  waitForDeployment(): Promise<this>;

  interface: RedStoneAdapterInterface;
  ...
  pushPrice: TypedContractMethod<
    [token: AddressLike, price: BigNumberish, updatedAt: BigNumberish],
    [void],
    "nonpayable"
  >;
